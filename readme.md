...
I am a **Software Engineer** focused on building scalable, resilient applications using the "Rails Way." With a **Bachelor’s in Information Systems (2016)** and currently pursuing an **MBA in Ruby on Rails Architecture**, I bridge the gap between complex business requirements and high-performance maintainable code.
...
* **Architecture:** Implementation of Service Objects, View Components, and Domain-Driven Design principles.
* **Quality:** 100% TDD approach with **RSpec** and **Capybara**.

### [KatsuYOU](https://github.com/FragozoLeonardo/KatsuYOU) 🇯🇵
*Ruby CLI Tool* | A complex linguistic utility for Japanese conjugation (verbs, adjectives, and nouns). It showcases my ability to handle complex conditional logic and algorithmic thinking in pure Ruby.

### [Genki-Yoshi](https://github.com/FragozoLeonardo/Genki-Yoshi) 📄
*Ruby CLI Tool* | Generates **Genkoyoshi (原稿用紙)** formatting. Demonstrates Ruby's file manipulation capabilities and precision in handling specific formatting requirements.
...
* **Languages:** Portuguese (Native), English (Fluent), Japanese (JLPT N3 Candidate - Target 2026).
* **Visa Status:** Bachelor's Degree holder (Eligible for Engineer/Specialist in Humanities Visa).
